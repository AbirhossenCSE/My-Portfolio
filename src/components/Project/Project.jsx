...
const projects = [
  {
    ...
    githubLink:
      "https://github.com/AbirhossenCSE/Employee-Management-Client",
    githubLinkServer:
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                <h3 className="text-2xl text-center font-semibold mb-6">{project.name}</h3>
                ...
                <div className="mt-6 flex justify-between items-center gap-3">
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 rounded-lg text-sm font-medium hover:from-green-600 hover:to-green-700 transition"
                  >
                    <FaExternalLinkAlt /> Live
                  </a>
                  <button
                    onClick={() => setSelectedProject(project)}
                    className="px-4 py-2 text-sm font-medium rounded-lg bg-gray-800 hover:bg-gray-700 transition"
                  >
                    Details
                  </button>
                </div>
